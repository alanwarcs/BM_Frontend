            ...
            <div className="flex-1 flex flex-raw bg-white">
                ...
                <aside className={`${isSidebarOpen ? "block" : "hidden"} absolute z-50 md:relative min-w-[260px] h-full p-4 transition-all duration-300 sidebar bg-gray-50 border-r`}>
                    <ul className="overflow-hidden">
                        <li className="m-1">
                            <Link to="/" className="flex items-center justify-center py-2 px-2 rounded-md text-sm bg-customPrimary text-white cursor-pointer">
                        ...
                        {/* Purchase Order */}
                        <li className="m-1">
                            <Link to="/purchaseorder" className="flex items-center justify-center p-2 rounded-md text-sm text-gray-600 hover:bg-gray-100 cursor-pointer">
                        ...
                        <li className="m-1">
                            <Link to="/items" className="flex items-center justify-center p-2 rounded-md text-sm text-gray-600 hover:bg-gray-100 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shopping-basket menu-icon me-4"><path d="m15 11-1 9"/><path d="m19 11-4-7"/><path d="M2 11h20"/><path d="m3.5 11 1.6 7.4a2 2 0 0 0 2 1.6h9.8a2 2 0 0 0 2-1.6l1.7-7.4"/><path d="M4.5 15.5h15"/><path d="m5 11 4-7"/><path d="m9 11 1 9"/></svg>
