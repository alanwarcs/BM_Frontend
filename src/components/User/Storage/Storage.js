                ...
                <div className="flex flex-row items-center justify-between px-3 text-2xl text-start py-2">
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className='relative p-2 m-1 bg-gray-100 rounded-md text-sm font-light hover:outline-none hover:bg-gray-200 transition'>
                            ...
                            {openFilterDropdown && (
                                <form onSubmit={handleApplyFilters} className='absolute top-12 right-0 mt-2 p-4 z-10 bg-white border border-gray-200 rounded-lg shadow-lg' ref={filterRef}>
                                    <div className='flex items-end gap-4'>
                                        ...
                                        <button type="submit" className='h-10 px-4 rounded-lg bg-customPrimary hover:bg-customPrimaryHover text-white text-sm font-medium transition-colors'>
                                            Apply
                                        </button>
                                    </div>
                                </form>
